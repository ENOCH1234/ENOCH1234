...
<a href="https://github.com/ENOCH1234">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=3B82F6&center=true&vCenter=true&width=700&lines=Senior+PHP+%2F+Laravel+Engineer;Full-Stack+%26+Blockchain+Developer;NLP+%26+AI+Researcher;Founder+%40+Knopee+Digital+Services" alt="Typing SVG" />
</a>
...
I also hold a **First Class B.Sc. in Computer Science (4.52/5.0 CGPA, Best Graduating Student)** and actively publish research in multilingual NLP, voice-based accessibility, and machine learning.
...
![Flutterwave](https://img.shields.io/badge/Flutterwave-F5A623?style=flat-square&logo=flutterwave&logoColor=white)
![Paystack](https://img.shields.io/badge/Paystack-00C3F7?style=flat-square)
![Korapay](https://img.shields.io/badge/Korapay-1A1A2E?style=flat-square)
...
📄 **Comprehending the Workings of a Finite State Machine Using Speech-to-Text Scenarios** *(2020)*  
→ [ResearchGate · 220+ reads](https://www.researchgate.net/publication/340717840)

**🔬 Active Research Interests:**
- Yoruba language NLP: tokenization, speech-to-text, voice cloning for low-resource African languages
- Multilingual speech translation pipelines (Yoruba · Hausa · English) for accessibility
- Deep Reinforcement Learning (DQN, SARSA) for real-time urban traffic optimization
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=ENOCH1234&theme=tokyonight&hide_border=true" />
</div>
...
## 💬 What I Bring to Global Teams

```
✅ Enterprise PHP/Laravel systems at scale (100,000+ users)
✅ React + TypeScript SPAs with robust API layers
✅ Real-time WebSocket applications (Laravel Reverb, Livewire, Alpine.js)
✅ Blockchain / Solana dApp development (PWA, Anchor Framework)
✅ Multi-region payment gateway integrations (NG / MU / US)
✅ AI/NLP research background with published Scopus-indexed work
✅ Cross-timezone client delivery & agency leadership
✅ End-to-end SDLC ownership: architecture → deployment → support
```
